...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try
		{
			xhr.open(request.Q, request.K, true);
		}
		catch (e)
		{
			return callback(_Scheduler_fail(elm$http$Http$BadUrl(request.K)));
		}
...
function _Http_toResponse(xhr)
{
	return {
		K: xhr.responseURL,
		aL: { az: xhr.status, k: xhr.statusText },
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aD: 'hidden', A: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aD: 'mozHidden', A: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aD: 'msHidden', A: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aD: 'webkitHidden', A: 'webkitvisibilitychange' }
		: { aD: 'hidden', A: 'visibilitychange' };
}
...
var author$project$Main$HttpData = F2(
	function (url, title) {
		return {q: title, K: url};
	});
...
var author$project$Main$dataDecoder = A3(
	...
	A3(
		...
		_List_fromArray(
			['data', 'image_mp4_url']),
		elm$json$Json$Decode$string,
		elm$json$Json$Decode$succeed(author$project$Main$HttpData)));
...
var author$project$Main$getRandomGif = function (topic) {
	return A2(
		...
		A2(
			...
			author$project$Main$dataDecoder));
};
var author$project$Main$init = function (stuff) {
	return _Utils_Tuple2(
		A3(author$project$Main$Model, 'lebowski', 'waiting.gif', 'lebowski'),
		author$project$Main$getRandomGif('lebowski'));
};
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				return _Utils_Tuple2(
					model,
					author$project$Main$getRandomGif(model.H));
			case 1:
				var newTopic = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var result = msg.a;
				if (!result.$) {
					var newHttpData = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{q: newHttpData.q, K: newHttpData.K}),
						elm$core$Platform$Cmd$none);
				} else {
...
var author$project$Main$SetTopic = function (a) {
	return {$: 1, a: a};
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2(elm$html$Html$Attributes$style, 'margin', '10px 0 10px'),
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$src(model.K),
						...
						_List_fromArray(
							[
								A2(elm$html$Html$Attributes$style, 'margin', '10px 20px')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onInput(author$project$Main$SetTopic),
...
var author$project$Main$main = elm$browser$Browser$document(
	{aF: author$project$Main$init, aM: author$project$Main$subscriptions, aN: author$project$Main$update, aO: author$project$Main$view});
